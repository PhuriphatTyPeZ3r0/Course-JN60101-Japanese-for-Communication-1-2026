---
tags: [jn, chapter5, moc]
course: JN60101
course-name: Japanese for Communication 1 (ภาษาญี่ปุ่นเพื่อการสื่อสาร 1)
chapter: 5
date: 2026-10-21
instructor: อาจารย์ ดร.เอกนรินทร์ จิรชีวีวงศ์
source: "บทที่ 5 การซื้อของ 2 JN60101.pdf"
---

# บทที่ 5 — Buying Things 2 (MOC)

<span class="material-symbols-outlined">arrow_back</span> บทก่อนหน้า: [[../Chapter4/Chapter4-MOC|MOC บทที่ 4]]
...
## <span class="material-symbols-outlined">assignment</span> ภาพรวมบทที่ 5 (สรุปย่อ)
...
## <span class="material-symbols-outlined">map</span> แผนที่หัวข้อบทที่ 5

```mermaid
graph TD
    MOC[บทที่ 5: Buying Things 2] --> A[[Shopping-Items-Vocabulary]]
    MOC --> B[[Countries-Made-In]]
    MOC --> C[[Adjectives-Size-Color]]
    MOC --> D[[Counters-Japanese]]
    MOC --> E[[Shopping-Dialogue-Practice]]

    A --> A1[เสื้อผ้า/เครื่องใช้/ผลไม้]
    B --> B1[doko no ~ desu ka]
    C --> C1[i-adjective + noun]
    D --> D1[tsu / mai / hon]
    E --> E1[บทสนทนาเต็มที่ร้านค้า]
...
<span class="material-symbols-outlined">arrow_forward</span> บทถัดไป: [[../Chapter6/Chapter6-MOC|MOC บทที่ 6]]
