...
```mermaid
graph TD
    MOC[บทที่ 6: Confirming Schedule] --> A[[Time-Expressions-Kinou-Ashita]]
    MOC --> B[[Ikimasu-Kimasu-Kaerimasu-Grammar]]
    MOC --> C[[Places-Vocabulary]]
    MOC --> D[[Date-Time-Expressions]]

    A --> A1[เมื่อวาน/วันนี้/พรุ่งนี้]
    A --> A2[สัปดาห์/เดือน/ปี ที่แล้ว-นี้-หน้า]
    B --> B1[Place+ni ikimasu/kimasu/kaerimasu]
    B --> B2[การผันรูป masu ครบ 4 แบบ]
    C --> C1[คำศัพท์สถานที่]
    C --> C2[dono + N]
    D --> D1[ปี/เดือน/วันที่ อ่านแบบไม่ตรงกฎ]
    D --> D2[วันในสัปดาห์ ...yōbi]
