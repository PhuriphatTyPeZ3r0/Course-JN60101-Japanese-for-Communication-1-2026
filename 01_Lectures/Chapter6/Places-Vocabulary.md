...
- **Kyōto (京都)** — เกียวโต
- **Ōsaka (大阪)** — โอซาก้า
- **shutchō (出張)** — การไปทำงานต่างจังหวัด/ต่างประเทศ (business trip)
- **shisha (支社)** — สาขา, สำนักงานสาขา (เช่น Ōsaka-shisha = สาขาโอซาก้า)
- **basu (バス)** — รถบัส
- **untenshu (運転手)** — คนขับรถ (เช่น basu no untenshu = คนขับรถบัส)
- **ginkō (銀行)** — ธนาคาร
...
> Dono basu ga ikimasu ka. = รถบัสคันไหนไป (ที่นั่น)

รูปแบบ "N no hito" ใช้บอกว่าคนคนนั้นมาจาก/สังกัดที่ไหน:
...
**Sumisu:** Sumimasen. Kono basu wa Shibuya ni ikimasu ka.
**Basu no untenshu:** Iie, ikimasen.
**Sumisu:** Dono basu ga ikimasu ka.
...
> [!important] คำอวยพรเมื่อมีคนไปทำธุระ
