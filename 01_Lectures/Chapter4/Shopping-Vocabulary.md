...
- **hito (人)** — คน
- **mise (店)** — ร้าน
- **en (円)** — เยน (หน่วยเงินญี่ปุ่น)
- **terebi** — โทรทัศน์
- **rajio** — วิทยุ
- **konpyūtā (= pasokon)** — คอมพิวเตอร์
- **kamera** — กล้องถ่ายรูป
- **dejikame** — กล้องดิจิทัล
- **bideo-kamera** — กล้องวิดีโอ
- **CD-purēyā** — เครื่องเล่นซีดี
- **tegami** — จดหมาย
- **kitte** — แสตมป์
- **fūtō** — ซองจดหมาย
- **zasshi** — นิตยสาร
