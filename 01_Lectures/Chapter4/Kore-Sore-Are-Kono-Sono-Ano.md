---
tags: [jn, chapter4, demonstratives, ikura]
course: JN60101
chapter: 4
date: 2026-10-07
---
...
**รูปแบบตอบราคา:** `[จำนวนเงิน]-en desu.`

**ข้อแตกต่างสำคัญ:** kore/sore/are ใช้แทนคำนามตัวมันเอง (ไม่ต้องมีคำนามตามหลัง) ส่วน kono/sono/ano **ต้องมีคำนามตามหลังเสมอ** เช่น "kono kaban" (กระเป๋าใบนี้), "sono jisho" (พจนานุกรมเล่มนั้น) — จะพูดลอย ๆ ว่า "kono" เฉย ๆ ไม่ได้

> [!example] ตัวอย่างประโยค
> Kore wa ikura desu ka? = นี่ราคาเท่าไหร่
