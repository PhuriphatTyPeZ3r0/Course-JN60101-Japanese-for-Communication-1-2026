...
```mermaid
graph TD
    MOC[บทที่ 4: Buying Things 1] --> A[[Shopping-Vocabulary]]
    MOC --> B[[Kore-Sore-Are-Kono-Sono-Ano]]
    MOC --> C[[Numbers-Hyaku-Sen]]
    MOC --> D[[Numbers-Man-Oku]]
    MOC --> E[[Shopping-Requests-Kudasai]]

    A --> A1[คำนามสิ่งของ/เครื่องใช้ไฟฟ้า]
    B --> B1[ถามราคา ikura desu ka]
    B --> B2[kono/sono/ano + คำนาม]
    C --> C1[hyaku 100-900 + จุดกลายเสียง]
    C --> C2[sen 1000-9000 + จุดกลายเสียง]
    D --> D1[man/oku/chō]
    D --> D2[ทศนิยม + เศษส่วน]
    E --> E1[misete kudasai / kudasai]
    E --> E2[คำช่วย mo]
    E --> E3[บทสนทนาซื้อของเต็มรูปแบบ]
