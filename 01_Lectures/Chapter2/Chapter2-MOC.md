...
```mermaid
graph TD
    MOC[บทที่ 2: Exchanging Business Cards] --> A[[Vocabulary-Personal-Items]]
    MOC --> B[[Vocabulary-Office-Language-Names]]
    MOC --> C[[Demonstratives-Kore-Sore-Are]]
    MOC --> D[[Possessive-No-Particle]]
    MOC --> E[[Question-Response-Words]]
    MOC --> F[[Numbers-1-10]]
    MOC --> G[[Greetings-Self-Intro-Dialogue]]

    A --> A1[คำนามสิ่งของส่วนตัว]
    B --> B1[สิ่งของสำนักงาน/ชื่อภาษา/คำทับศัพท์ Katakana]
    C --> C1[kore/sore/are]
    C --> C2[kono/sono/ano + Noun]
    D --> D1[ความเป็นเจ้าของ]
    D --> D2[บอกรายละเอียด N2]
    E --> E1[nan / sō desu / chigaimasu]
    F --> F1[ตัวเลข 1-10]
    F --> F2[อ่านเบอร์โทรศัพท์]
    G --> G1[Jiko Shōkai แนะนำตัว]
    G --> G2[บทสนทนาแลกนามบัตร]
