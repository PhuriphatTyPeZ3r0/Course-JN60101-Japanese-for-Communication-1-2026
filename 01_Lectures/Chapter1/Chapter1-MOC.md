...
```mermaid
graph TD
    MOC[บทที่ 1: Self-Introduction] --> A[[Japanese-Writing-System]]
    MOC --> B[[Pronunciation-Rules]]
    MOC --> C[[Sentence-Structure-Wa-Desu]]
    MOC --> D[[Pronouns-Honorifics]]
    MOC --> E[[Occupations-Nationality]]
    MOC --> F[[Self-Introduction-Dialogue]]

    A --> A1[hiragana/katakana/kanji]
    B --> B1[shi/chi/tsu/fu ข้อยกเว้น]
    B --> B2[เสียงยาว/ตัวสะกดซ้ำ]
    C --> C1[wa...desu / dewa arimasen / desu ka]
    D --> D1[-san/-chan/-kun]
    E --> E1[N1 no N2]
    E --> E2[-jin สัญชาติ]
    F --> F1[Jiko Shokai]
    F --> F2[แนะนำคนอื่นให้รู้จักกัน]
