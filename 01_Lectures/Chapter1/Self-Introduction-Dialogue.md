---
tags: [jn, chapter1, dialogue, greeting]
course: JN60101
chapter: 1
date: 2026-09-09
---
...
- **o-namae wa? (お名前は？)** — คุณชื่ออะไร (สุภาพ, o- เป็นคำเติมหน้าเพื่อความสุภาพ)
- **hajimemashite (はじめまして)** — ยินดีที่ได้รู้จัก (ใช้ตอนเจอกันครั้งแรกเท่านั้น)
- **dōzo yoroshiku onegaishimasu (どうぞよろしくお願いします)** — ฝากตัวด้วยนะคะ/ครับ (พูดปิดท้ายการแนะนำตัว)
- **kochira wa ...-san desu (こちらは〜さんです)** — นี่คือคุณ... (ใช้แนะนำคนอื่นให้รู้จักกัน)
...
2. Watashi wa [ชื่อ] desu. (บอกชื่อ — **ห้ามต่อ -san ท้ายชื่อตัวเอง**)
3. [สถานศึกษา/บริษัท] no [อาชีพ/สถานะ] desu. (บอกสังกัด+สถานะ ด้วยคำช่วย no)
4. Dōzo yoroshiku onegaishimasu. (ปิดท้าย)
...
**ที่แผนกต้อนรับบริษัท:**

**Sumisu:** ABC Fūzu no Sumisu desu. Takahashi-san o onegaishimasu. (ขอพบคุณทาคาฮาชิ)
**Uketsuke:** Hai.

**เสียงออดที่บ้าน:**

**Chan:** Hai. Donata desu ka.
