---
tags: [jn, chapter1, pronouns, honorifics]
course: JN60101
chapter: 1
date: 2026-09-09
---
...
- **anata (あなた)** — คุณ (บุรุษที่ 2)
- **anohito (あの人) / anokata (あの方)** — เขา/เธอ (บุรุษที่ 3) — anokata สุภาพกว่า anohito
- **mina-san (みなさん)** — ทุกท่าน/ทุกคน
- **dare (誰) / donata (どなた)** — ใคร — donata สุภาพกว่า dare
- **-san (さん)** — คุณ... (ต่อท้ายชื่อคนอื่น ใช้ได้ทั้งชาย-หญิง สุภาพ)
...
**คำต่อท้ายชื่อ (Name Suffixes):** ต่อท้ายชื่อคนอื่นเพื่อแสดงความสุภาพ/ความสัมพันธ์เสมอ

| suffix | ใช้กับ | ตัวอย่าง |
| --- | --- | --- |
| -san | ทุกคนโดยทั่วไป (เป็นกลาง สุภาพ) | Yamada-san, Nakamoto-san |
| -chan | เด็ก/คนสนิทมาก (มักเป็นเด็กหญิง) | — |
| -kun | เด็กผู้ชาย/รุ่นน้องผู้ชาย | — |
