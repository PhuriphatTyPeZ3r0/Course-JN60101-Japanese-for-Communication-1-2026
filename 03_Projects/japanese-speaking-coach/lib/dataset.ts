...
export const VOCABULARY_LIST: VocabItem[] = [
  ...
  { id: "v1_kaisha", th: "บริษัท", ja: "かいしゃ", romaji: "kaisha", altJa: "会社", chapter: 1, category: "สถานที่" },
  { id: "v1_hisho", th: "เลขานุการ", ja: "ひしょ", romaji: "hisho", altJa: "秘書", chapter: 1, category: "อาชีพ" },
  { id: "v1_bengoshi", th: "ทนายความ", ja: "べんごし", romaji: "bengoshi", altJa: "弁護士", chapter: 1, category: "อาชีพ" },
  { id: "v1_denki", th: "ไฟฟ้า", ja: "でんき", romaji: "denki", altJa: "電気", chapter: 1, category: "สิ่งของ" },
  { id: "v1_namae", th: "ชื่อ", ja: "なまえ", romaji: "namae", altJa: "名前", chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_watashi", th: "ฉัน / ผม", ja: "わたし", romaji: "watashi", altJa: "私", chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_watashitachi", th: "พวกเรา", ja: "わたしたち", romaji: "watashi-tachi", altJa: "私たち", altRomaji: ["watashitachi"], chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_anata", th: "คุณ", ja: "あなた", romaji: "anata", chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_anohito", th: "คนนั้น / เขา", ja: "あのひと", romaji: "anohito", altJa: "あのかた", altRomaji: ["anokata"], chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_minasan", th: "ทุกคน / ทุกท่าน", ja: "みなさん", romaji: "mina-san", altRomaji: ["minasan", "mina"], chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_dare", th: "ใคร?", ja: "だれ", romaji: "dare", altJa: "どなた", altRomaji: ["donata"], chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_sai", th: "ขวบ / ปี (บอกอายุ)", ja: "さい", romaji: "-sai", altJa: "歳", altRomaji: ["sai"], chapter: 1, category: "ลักษณนาม" },
  { id: "v1_nansai", th: "อายุเท่าไหร่?", ja: "なんさい", romaji: "nansai", altJa: "おいくつ", altRomaji: ["o-ikutsu", "oikutsu"], chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_nihon", th: "ประเทศญี่ปุ่น", ja: "にほん", romaji: "Nihon", altJa: "日本", altRomaji: ["Nippon"], chapter: 1, category: "สถานที่" },
  { id: "v1_chugoku", th: "ประเทศจีน", ja: "ちゅうごく", romaji: "Chūgoku", altJa: "中国", altRomaji: ["chugoku", "chuugoku"], chapter: 1, category: "สถานที่" },
  { id: "v1_chugokujin", th: "คนจีน", ja: "ちゅうごくじん", romaji: "Chūgoku-jin", altJa: "中国人", altRomaji: ["chugokujin", "chuugokujin"], chapter: 1, category: "สัญชาติ" },
  { id: "v1_kankoku", th: "ประเทศเกาหลีใต้", ja: "かんこく", romaji: "Kankoku", altJa: "韓国", chapter: 1, category: "สถานที่" },
  { id: "v1_kankokujin", th: "คนเกาหลี", ja: "かんこくじん", romaji: "Kankoku-jin", altJa: "韓国人", altRomaji: ["kankokujin"], chapter: 1, category: "สัญชาติ" },
  { id: "v1_doitsujin", th: "คนเยอรมัน", ja: "ドイツじん", romaji: "Doitsu-jin", altRomaji: ["doitsujin"], chapter: 1, category: "สัญชาติ" },
  { id: "v1_igirisujin", th: "คนอังกฤษ", ja: "イギリスじん", romaji: "Igirisu-jin", altRomaji: ["igirisujin"], chapter: 1, category: "สัญชาติ" },
  { id: "v1_osutoraria", th: "ประเทศออสเตรเลีย", ja: "オーストラリア", romaji: "Ōsutoraria", altRomaji: ["osutoraria"], chapter: 1, category: "สถานที่" },
  { id: "v1_osutorariajin", th: "คนออสเตรเลีย", ja: "オーストラリアじん", romaji: "Ōsutoraria-jin", altRomaji: ["osutorariajin"], chapter: 1, category: "สัญชาติ" },
  { id: "v1_tai", th: "ประเทศไทย", ja: "タイ", romaji: "Tai", chapter: 1, category: "สถานที่" },
  { id: "v1_amerika", th: "ประเทศอเมริกา", ja: "アメリカ", romaji: "Amerika", chapter: 1, category: "สถานที่" },
  { id: "v1_shitsurei", th: "ขอโทษนะครับ/ค่ะ (ก่อนถามข้อมูล)", ja: "しつれいですが", romaji: "shitsurei desuga", altJa: "失礼ですが", chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_onamaewa", th: "คุณชื่ออะไร? (สุภาพ)", ja: "おなまえは", romaji: "o-namae wa", altJa: "お名前は", altRomaji: ["onamae wa"], chapter: 1, category: "คำศัพท์ทั่วไป" },
  { id: "v1_hajimemashite", th: "ยินดีที่ได้รู้จัก (เจอกันครั้งแรก)", ja: "はじめまして", romaji: "hajimemashite", chapter: 1, category: "คำศัพท์ทั่วไป" },
  ...
  { id: "v2_enpitsu", th: "ดินสอ", ja: "えんぴつ", romaji: "enpitsu", altJa: "鉛筆", chapter: 2, category: "เครื่องเขียน" },
  { id: "v2_keitai", th: "โทรศัพท์มือถือ", ja: "けいたい", romaji: "keitai", altJa: "携帯", altRomaji: ["keitai denwa", "sumaho"], chapter: 2, category: "สิ่งของ" },
  { id: "v2_jusho", th: "ที่อยู่", ja: "じゅうしょ", romaji: "jūsho", altJa: "住所", altRomaji: ["juusho", "jusho"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_denwabango", th: "หมายเลขโทรศัพท์", ja: "でんわばんごう", romaji: "denwa bangō", altJa: "電話番号", altRomaji: ["denwa bango", "denwa bangou"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_eigo", th: "ภาษาอังกฤษ", ja: "えいご", romaji: "Eigo", altJa: "英語", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_nihongo", th: "ภาษาญี่ปุ่น", ja: "にほんご", romaji: "Nihongo", altJa: "日本語", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_chugokugo", th: "ภาษาจีน", ja: "ちゅうごくご", romaji: "Chūgokugo", altJa: "中国語", altRomaji: ["chugokugo", "chuugokugo"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_kankokugo", th: "ภาษาเกาหลี", ja: "かんこくご", romaji: "Kankokugo", altJa: "韓国語", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_taigo", th: "ภาษาไทย", ja: "タイご", romaji: "Tai-go", altRomaji: ["taigo"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_kado", th: "บัตร / การ์ด", ja: "カード", romaji: "kādo", altRomaji: ["kado", "kaado"], chapter: 2, category: "สิ่งของ" },
  { id: "v2_terehonkado", th: "บัตรโทรศัพท์", ja: "テレホンカード", romaji: "terehon kādo", altRomaji: ["terehon kado"], chapter: 2, category: "สิ่งของ" },
  { id: "v2_chokoreto", th: "ช็อกโกแลต", ja: "チョコレート", romaji: "chokorēto", altRomaji: ["chokoreto"], chapter: 2, category: "อาหาร/เครื่องดื่ม" },
  { id: "v2_kohi", th: "กาแฟ", ja: "コーヒー", romaji: "kōhī", altRomaji: ["kohi", "koohii"], chapter: 2, category: "อาหาร/เครื่องดื่ม" },
  { id: "v2_meruadoresu", th: "ที่อยู่อีเมล", ja: "メールアドレス", romaji: "mēru adoresu", altRomaji: ["meru adoresu"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_kore", th: "สิ่งนี้ / นี่", ja: "これ", romaji: "kore", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_sore", th: "สิ่งนั้น / นั่น", ja: "それ", romaji: "sore", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_are", th: "สิ่งโน้น / โน่น", ja: "あれ", romaji: "are", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_kono", th: "...นี้ (นำหน้านาม)", ja: "この", romaji: "kono", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_sono", th: "...นั้น (นำหน้านาม)", ja: "その", romaji: "sono", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_ano", th: "...โน้น (นำหน้านาม)", ja: "あの", romaji: "ano", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_nan", th: "อะไร?", ja: "なん", romaji: "nan", altJa: "なに", altRomaji: ["nani"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_hai", th: "ใช่ / ครับ / ค่ะ", ja: "はい", romaji: "hai", altJa: "ええ", altRomaji: ["ee"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_so", th: "เช่นนั้น / อย่างนั้น", ja: "そう", romaji: "sō", altRomaji: ["so", "sou"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_chigaimasu", th: "ไม่ใช่ / แตกต่าง / ผิด", ja: "ちがいます", romaji: "chigaimasu", altJa: "違います", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_anou", th: "เอ่อ... / คือว่า... (เกริ่น)", ja: "あのう", romaji: "anō", altRomaji: ["anou", "ano"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_domoarigatou", th: "ขอบคุณเป็นอย่างยิ่งครับ/ค่ะ", ja: "どうもありがとうございます", romaji: "dōmo arigatō gozaimasu", altRomaji: ["doumo arigatou gozaimasu"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_domosumimasen", th: "ขอโทษเป็นอย่างสูง / ขอบคุณมาก", ja: "どうもすみません", romaji: "dōmo sumimasen", altRomaji: ["doumo sumimasen"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_korekaraosewa", th: "จากนี้ไปขอฝากเนื้อฝากตัวด้วย", ja: "これからおせわになります", romaji: "kore kara osewa ni narimasu", altJa: "これからお世話になります", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_douzo", th: "เชิญครับ/ค่ะ / นี่ครับ/ค่ะ", ja: "どうぞ", romaji: "dōzo", altRomaji: ["douzo"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_jikoshokai", th: "การแนะนำตนเอง", ja: "じこしょうかい", romaji: "jiko shōkai", altJa: "自己紹介", altRomaji: ["jiko shokai", "jikoshoukai"], chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_shumi", th: "งานอดิเรก", ja: "しゅみ", romaji: "shumi", altJa: "趣味", chapter: 2, category: "คำศัพท์ทั่วไป" },
  { id: "v2_num_1", th: "หนึ่ง (1)", ja: "いち", romaji: "ichi", chapter: 2, category: "ตัวเลข/ราคา" },
  { id: "v2_num_2", th: "สอง (2)", ja: "に", romaji: "ni", chapter: 2, category: "ตัวเลข/ราคา" },
  { id: "v2_num_3", th: "สาม (3)", ja: "さん", romaji: "san", chapter: 2, category: "ตัวเลข/ราคา" },
  { id: "v2_num_4", th: "สี่ (4)", ja: "よん", romaji: "yon", altJa: "し", altRomaji: ["shi"], chapter: 2, category: "ตัวเลข/ราคา" },
  { id: "v2_num_5", th: "ห้า (5)", ja: "ご", romaji: "go", chapter: 2, category: "ตัวเลข/ราคา" },
  { id: "v2_num_6", th: "หก (6)", ja: "ろく", romaji: "roku", chapter: 2, category: "ตัวเลข/ราคา" },
  { id: "v2_num_7", th: "เจ็ด (7)", ja: "なな", romaji: "nana", altJa: "しち", altRomaji: ["shichi"], chapter: 2, category: "ตัวเลข/ราคา" },
